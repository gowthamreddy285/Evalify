      ...
      >
        <div className="relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-[#707070] text-sm font-medium tracking-tight">Access your simulation cockpit</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? 'Authenticating...' : 'Engage Access'}
            </button>
          </form>

          <div className="relative my-10">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/5"></div></div>
            <div className="relative flex justify-center text-[10px]"><span className="px-4 bg-[#0A0A0A] text-[#707070] font-black uppercase tracking-widest">Or Secure Login via</span></div>
          </div>
          ...
          <p className="mt-10 text-center text-[10px] font-bold text-[#707070] uppercase tracking-widest">
            New operative? <Link to="/signup" className="text-[#D4121B] hover:text-[#FF3B3B] transition-colors ml-1">Request Registry</Link>
          </p>
        </div>
      </motion.div>
    </div>
