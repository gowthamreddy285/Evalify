      ...
      >
        <div className="relative z-10">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-[#F5F5F5] uppercase tracking-tighter mb-2">Welcome Back.</h1>
            <p className="text-[#707070] text-xs font-black uppercase tracking-[0.2em]">Sign in to your session</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-4 bg-[#D4121B] hover:bg-[#FF3B3B] text-white font-black uppercase tracking-[0.2em] text-xs rounded-xl btn-shine transition-all shadow-xl shadow-[#D4121B]/20 disabled:opacity-50"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-[#707070] text-[10px] font-black uppercase tracking-widest">
              Don't have an account? <Link to="/signup" className="text-[#D4121B] hover:text-[#FF3B3B] transition-colors ml-1">Create One</Link>
            </p>
          </div>
        </div>
      </motion.div>
