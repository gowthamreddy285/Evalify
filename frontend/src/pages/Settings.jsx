...
export default function Settings() {
  ...
  const handleDelete = async () => {
    ...
    if (confirmed) {
      addToast('Account deletion pending implementation', 'info');
    }
  };
            ...
            <div className="space-y-8">
              <div className="p-8 rounded-3xl bg-[#030303] border border-white/5">
                ...
                <div className="space-y-6">
                  <button className="w-full py-4 px-6 bg-white/5 hover:bg-white/10 text-[#F5F5F5] font-black uppercase tracking-widest text-[10px] rounded-xl border border-white/5 text-left transition-all">
              ...
              <div className="p-8 rounded-3xl bg-[#D4121B]/5 border border-[#D4121B]/10">
                ...
                <p className="text-[#707070] text-xs font-medium mb-8 leading-relaxed">Permanently terminate your profile and purge all session data from the archive.</p>
                <button 
                  onClick={handleDelete}
                  className="py-4 px-8 bg-[#D4121B] hover:bg-[#FF3B3B] text-white font-black uppercase tracking-widest text-[10px] rounded-xl btn-shine transition-all"
                >
                  Terminate Profile
                </button>
              </div>
