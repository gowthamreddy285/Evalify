          ...
          <div className="min-h-screen bg-[#030303] text-[#F5F5F5] overflow-x-hidden selection:bg-[#D4121B]/30">
            ...
            <AnimatePresence mode="wait">
              <Routes>
                ...
                <Route path="/interview/session" element={<ProtectedRoute><Session /></ProtectedRoute>} />
                <Route path="/interview/results" element={<ProtectedRoute><Results /></ProtectedRoute>} />
                <Route path="/interview/results/:sessionId" element={<ProtectedRoute><SessionDetail /></ProtectedRoute>} />
