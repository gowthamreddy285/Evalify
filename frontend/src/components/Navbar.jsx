      ...
      <div className="flex items-center gap-4 pointer-events-auto">
        {token ? (
          <>
            ...
            <button onClick={() => navigate('/profile')} className="bg-[#0A0A0A] border border-white/5 p-2.5 rounded-xl noise-overlay cursor-pointer hover:border-[#D4121B]/40 transition-all text-[#707070] hover:text-[#D4121B]" title="Profile">
