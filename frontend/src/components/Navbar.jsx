...
export default function Navbar() {
  ...
  // Always show navbar now that login is removed
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-8 py-6 flex items-center justify-between pointer-events-none">
      <div className="flex items-center gap-6 pointer-events-auto">
        <button onClick={() => navigate('/')} className="bg-[#0A0A0A] border border-white/5 px-4 py-2.5 rounded-xl noise-overlay cursor-pointer hover:border-[#D4121B]/50 transition-all text-[10px] font-black uppercase tracking-widest text-[#707070] hover:text-[#D4121B]">
          Home
        </button>
      ...
      <div className="flex items-center gap-4 pointer-events-auto">
        ...
        <button onClick={() => navigate('/profile')} className="bg-[#0A0A0A] border border-white/5 p-2.5 rounded-xl noise-overlay cursor-pointer hover:border-[#D4121B]/40 transition-all text-[#707070] hover:text-[#D4121B]">
        ...
        <button onClick={() => navigate('/settings')} className="bg-[#0A0A0A] border border-white/5 p-2.5 rounded-xl noise-overlay cursor-pointer hover:border-[#D4121B]/40 transition-all text-[#707070] hover:text-[#D4121B]">
